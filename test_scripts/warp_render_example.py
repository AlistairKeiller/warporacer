...
class ExampleImGuiManager(ImGuiManager):
    ...
    def draw_ui(self):
        ...
        self.imgui.set_next_window_size(self.imgui.ImVec2(self.window_size[0], self.window_size[1]))
        self.imgui.set_next_window_pos(self.imgui.ImVec2(self.window_pos[0], self.window_pos[1]))
